...
“Mis ejercicios” combina primero los movimientos personalizados del coach (`coach-<id>`) y después los 183 movimientos incluidos. Permanece abierta después de añadir un ejercicio para permitir selección múltiple y el pie muestra el número agregado al día activo. Al insertar un ejercicio personalizado, se copian nombre, músculo, indicaciones y video dentro de la rutina. Editar o eliminar posteriormente la ficha del catálogo no cambia las rutinas ya entregadas.
