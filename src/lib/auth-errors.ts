export function authErrorMessage(error: unknown): string {
 ...
 if(e?.code==='email_not_confirmed')return 'Confirma tu correo una sola vez desde «Primera vez: crear contraseña».';
 if(e?.code==='invalid_credentials')return 'Correo o contraseña incorrectos. Si aún no tienes contraseña, selecciona «Primera vez: crear contraseña».';
