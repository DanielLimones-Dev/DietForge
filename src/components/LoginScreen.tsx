...
export function LoginScreen() {
 ...
 return <div className="df-login">
  ...
  <section className="df-login-form"><div className="w-full max-w-sm">
   ...
   <h2 className="text-3xl font-semibold tracking-tight mt-2">{sent?"Revisa tu correo":mode==="setup"?"Activa tu cuenta":mode==="recovery"?"Recupera tu contraseña":"Inicia sesión"}</h2>
