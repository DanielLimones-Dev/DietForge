...
import { ShieldCheck, Users, Clock, Plus, RefreshCw, Search } from "lucide-react";
...
export function AdminPanel(){
 ...
 function open(coach:Coach|null){setSelected(coach);setAdding(!coach);setEmail(coach?.email??"");setMonths(1);setNote("");setError("");setNotice("");request.current=null;}
 ...
 return <div className="admin-page">
  <header className="admin-header"><div><span className="admin-master-pill"><i/>Panel maestro de administración</span><h1>Gestión de coaches y periodos de acceso</h1><p>Alta de cuentas, renovaciones, suspensiones y actividad administrativa desde un solo lugar.</p></div><button className="df-button" disabled={busy} onClick={()=>open(null)}><Plus size={18}/>Dar de alta coach</button></header>
