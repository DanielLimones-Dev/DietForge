...
export function TrainingVideoEditor({value,onChange,label,initiallyOpen=false,iconOnly=false}:{value:string;onChange:(value:string)=>void;label:string;initiallyOpen?:boolean;iconOnly?:boolean}){
