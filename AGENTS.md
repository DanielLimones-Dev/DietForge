...
- Calcular o guardar una evaluación de macros nunca crea un check-in. Las evaluaciones se conservan como historial navegable, con la más reciente en la posición 1. Cada check-in compara peso y porcentaje de grasa contra el registro anterior más reciente por fecha, ya sea evaluación o check-in. Las gráficas antropométricas combinan peso y grasa de ambas fuentes, con prioridad para el check-in cuando comparten fecha; promedios, adherencia, tendencia y demás seguimiento propio del check-in permanecen separados.
