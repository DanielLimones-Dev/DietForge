...
- `/` presenta el acceso para coaches y enlaza explícitamente a `/admin/login`. La ruta separada mejora claridad, pero la autorización administrativa siempre depende de `dietforge_is_admin()` en el servidor.
